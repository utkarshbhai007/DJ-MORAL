...
import { ChevronLeft, ChevronRight, X, Instagram, Music, Youtube } from 'lucide-react';
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
const Gallery = () => {
  ...
  // Updated gallery with corrected image paths for deployment
  const galleryImages = [
    {
        ...
        <div className="text-center mb-16 relative">
          ...
          <div className="flex items-center justify-center gap-6 mt-8">
            <a 
              ...
              className="flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:scale-105 transform transition-all duration-300 text-sm"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-orange-500 to-red-500 text-white hover:scale-105 transform transition-all duration-300 text-sm"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-red-600 to-red-700 text-white hover:scale-105 transform transition-all duration-300 text-sm"
            >
